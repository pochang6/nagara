...
1. **ログイン項目に登録**されるので、Mac を再起動しても勝手に常駐します（初回起動時に自動登録。メニューから外せます）
2. **CLI が本体を起こします。** `nagara ...` を叩いたとき落ちていれば `open -g` で起動します
3. **Stop フックも本体を起こします。** 落ちていれば起動を待ちます（**待つのは3秒まで**。フックが理由で Claude Code が待たされるのは本末転倒なので、そこで諦めます）
